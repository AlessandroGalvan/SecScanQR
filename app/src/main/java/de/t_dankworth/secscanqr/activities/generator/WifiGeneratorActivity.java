...
public class WifiGeneratorActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGenerate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(ssid.isEmpty() || (encrypt.equals("WEP") && password.isEmpty()) || (encrypt.equals("WPA") && password.isEmpty())){
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if(compare.equalsIgnoreCase("AZTEC")){
            format = 10;
        } else if(compare.equalsIgnoreCase("QR_CODE")){
            format = 9;
        } else if(compare.equalsIgnoreCase("NONE")){
            encrypt = "nopass";
            tfPassword.setVisibility(View.GONE);
        } else if (compare.equalsIgnoreCase("WEP")){
            encrypt = "WEP";
            tfPassword.setVisibility(View.VISIBLE);
        } else if (compare.equalsIgnoreCase("WPA/WPA2")){
            encrypt = "WPA";
            tfPassword.setVisibility(View.VISIBLE);
        }
    }
