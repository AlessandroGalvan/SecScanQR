        ...
        switch (item.getItemId()){
            ...
            case R.id.history_optionsmenu_share:
                ...
                for(int i = 0; i < adapter.getItemCount(); i++){
                    export.append("DATE:").append(adapter.getHistoryEntryAt(i).getDate()).append("\n");
                    export.append("FORMAT:").append(adapter.getHistoryEntryAt(i).getFormat()).append("\n");
                    export.append("INFO:").append(adapter.getHistoryEntryAt(i).getInformation()).append("\n");
                    export.append("\n");
                }
                shareTo(export.toString(), activity);
                return true;
            default:
